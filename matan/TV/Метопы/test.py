...
def create_next_population(parents):
    ...
    for pair in pairs:
        ...
        print(
            f"Скрешиваем: {get_sequence_with_break_points(parent_1_sequence, break_point_1, break_point_2)} {get_sequence_with_break_points(parent_2_sequence, break_point_1, break_point_2)}"
        )
        ...
        print(
            f"Получены потомки:{get_sequence_with_break_points(child_1, break_point_1, break_point_2)} {get_sequence_with_break_points(child_2, break_point_1, break_point_2)}"
        )
        print("")
...
while True:
    ...
    for way in population:
        print(
            f'{"".join(map(str, way.sequence))} | {way.f()} | {way.f()}/{sum_of_distances}'
        )
...
print(
    "Оптимальный путь:",
    "".join(map(str, optimal_way.sequence)),
    "Расстояние:",
    optimal_way.f(),
)
